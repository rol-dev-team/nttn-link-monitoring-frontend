...
<div className="flex flex-col lg:flex-row gap-4">
  ...
  <div className="flex-1 bg-white rounded-2xl shadow-md p-4">
    ...
    <div className="h-[250px] lg:h-[300px]">
      <Chart type="line" data={createLineChartData('CPU', cpuData, '#4f46e5')} options={chartOptions} />
    </div>
  </div>
  ...
  <div className="flex-1 bg-white rounded-2xl shadow-md p-4">
    ...
    <div className="h-[250px] lg:h-[300px]">
      <Chart type="line" data={createLineChartData('RAM', ramData, '#16a34a')} options={chartOptions} />
    </div>
  </div>
  ...
  <div className="flex-1 bg-white rounded-2xl shadow-md p-4">
    ...
    <div className="h-[250px] lg:h-[300px]">
      <Chart type="line" data={createLineChartData('Disk', diskData, '#f59e0b')} options={chartOptions} />
    </div>
  </div>
</div>) : (
  <div className="flex justify-center items-center h-64">
    <p className="text-gray-500">No resource monitoring data available. Please perform a search.</p>
    </div>
)}
