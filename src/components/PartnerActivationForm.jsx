...
const ActivationPlanSchema = Yup.object().shape({
    ...
    nttn_work_order_id: Yup.string().required(
...
export default function PartnerActivationForm({
    ...
    console.log('jkdshfkjdshkfhdskhfksd',clientOptions);
    return (
...
useEffect(() => {
    if (selectedLinkID) {
        const fetchDetails = async () => {
            ...
            try {
                ...
                if (response.status === 'success' && response.data) {
                    ...
                    // ✅ SET CLIENT_ID FROM THE RESPONSE
                    if (response.data.client_id) {
                        formik.setFieldValue("client_id", response.data.client_id);
                        console.log("✅ Auto-set client_id from API:", response.data.client_id);
                    }
                    ...
                    setPartnerDetails({});
                    formik.setFieldValue("client_id", ""); // Reset client_id on error
                }
            } catch (error) {
        ...
        setPartnerDetails({});
        formik.setFieldValue("client_id", ""); // Reset client_id when no selection
    }
                    ...
                    <SelectField
                        ...
                        onChange={(selectedValue) => { 
                            ...
                            if (selectedClient) {
                                ...
                                const clientId = selectedClient.client_id ? selectedClient.client_id.toString() : "";
