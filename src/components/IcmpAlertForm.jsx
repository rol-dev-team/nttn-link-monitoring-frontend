...
// Main Component
export default function IcmpAlertForm({ initialValues, isEditMode, onSubmit, onCancel, nasIps }) {
          ...
          return (
            <Form className="grid grid-cols-1 gap-x-14 gap-y-0">
                ...
                {selectAllActive ? (
                  <div className="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                    <p className="text-blue-700 font-medium">
                      ✅ All NAS IPs ({nasIps.length} total) will be configured
                    </p>
                  </div>
                ) : selectedCount > 0 ? (
              ...
              <div className="md:col-span-2 mb-8">
                <h3 className="text-2xl font-semibold text-gray-800 mb-6">Latency Threshold</h3>
                ...
                <p className="text-sm text-gray-500 mt-2">
                  Set the maximum acceptable latency in milliseconds. Alerts will trigger when
                ...
                <Button
                  ...
                  loadingText={
                    isEditMode
                      ? 'Updating...'
                      : `Creating ${
                          selectAllActive ? nasIps.length : selectedCount || 0
                        } Configuration(s)...`
                  }
