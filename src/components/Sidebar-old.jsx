...
export default function Sidebar({ collapsed, setCollapsed }) {
  ...
  console.log('🚀 ~ file: Sidebar.jsx ~ line 75 ~ Sidebar ~ dynamicTree', dynamicTree);
      ...
      <div className="px-2 pb-4 overflow-y-auto flex-1">
        ...
        {isLoading && !showFallback && (
          <div className="flex flex-col items-center justify-center p-4 text-center">
            ...
            <div className="text-sm opacity-70">Loading menu...</div>
          </div>
        )}
        ...
        {showFallback && !isLoading && (
          <div className="p-3 text-center">
            ...
            <div className="text-xs opacity-70 mb-2">Using offline menu</div>
          </div>
        )}
        ...
        return (
          <li key={`${node.label}-${node.path || 'no-path'}`} className="relative">
            {disabled ? (
              ...
              >
                <IconRenderer fa={fa} />
                <span className="twoline flex-1 min-w-0" title={node.label}>
                  {node.label}
                </span>
              </span>
            ) : (
