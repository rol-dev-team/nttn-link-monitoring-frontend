// src/components/kam/KamForm.jsx
...
import { KamSchema } from "../../validations/kamValidation";
...
const KamForm = ({ initialValues, isEditMode, onSubmit, onCancel, showToast }) => {
        ...
        <div className="flex items-center space-x-3 mb-6 md:mb-8">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">
              {isEditMode ? "Edit KAM" : "Add KAM"}
            </h1>
            <p className="text-gray-500">
              Fill in the details to {isEditMode ? "update" : "add a new"} Key Account Manager.
            </p>
          </div>
        </div>

        {/* Single section – same grid */}
        <FormSection title="KAM Information">
          <InputField
            name="kam_name"
            label="KAM Name *"
