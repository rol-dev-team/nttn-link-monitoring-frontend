  ...
  const UserForm = ({
      ...
      switch (name) {
        ...
        case "first_name":
          if (!value.trim()) error = "First name is required";
            ...
            error = "First name must be less than 255 characters";
          break;
        case "last_name":
          if (!value.trim()) error = "Last name is required";
          else if (value.length > 255)
            error = "Last name must be less than 255 characters";
          break;
        case "email":
        ...
        case "mobile":
          if (!value.trim()) error = "Mobile number is required";
            ...
            error = "Mobile number must be less than 20 characters";
          break;
        case "password":
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        await onSubmit(
          isEditing ? { userId: userToEdit.id, payload } : payload
        );
        onSuccess();
      } catch (err) {
      ...
      <dialog ref={editDialogRef} className='modal bg-black bg-opacity-50'>
        <div className='modal-box relative p-6 bg-base-100 rounded-lg shadow-xl w-11/12 max-w-2xl'>
          <h3 className='font-bold text-lg mb-4'>
            Edit User: {modalState.user?.name}
          </h3>
          <UserForm
            onSubmit={updateUser}
            onCancel={() => setModalState({ type: null, user: null })}
      ...
      <dialog ref={deleteDialogRef} className='modal bg-black bg-opacity-50'>
        <div className='modal-box relative p-6 bg-base-100 rounded-lg shadow-xl w-11/12 max-w-2xl'>
          ...
          <p className='py-4'>
            ...
            <strong>{modalState.user?.name}</strong>? This action cannot be
            undone.
          </p>
          <div className='modal-action'>
            ...
            <button
              ...
              onClick={() => handleAction(deleteUser, modalState.user.id)}
              disabled={isProcessing}>
