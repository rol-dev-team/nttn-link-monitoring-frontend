...
// import { createTechnicalKam } from "../services/partner-link/technicalKam";
...
//         .matches(
//             /^(?:(?:\+|00)?88)?01[3-9]\d{8}$/,
//             "Invalid cell number format (e.g., 01XXXXXXXXX)"
//         )
...
// export default function TechnicalKAMForm({
//     initialValues,
//     isEditMode,
//     onSubmit,
//     onCancel,
...
//         ? "Edit Technical KAM Details"
//         : "Technical KAM Registration";
...
//                         {isEditMode
//                             ? "Modify the existing Technical KAM's details."
//                             : "Register a new Technical KAM for operations."}
//                     </p>
//                 </div>
//             </header>
...
// ================================================================
// 2. Initial Values Helper (UPDATED for API compatibility)
// ================================================================
const getInitialValues = (initialData) => {
    ...
    return {
        name: initialData?.name || "",
        designation: initialData?.designation || "",
        cell_number: initialData?.mobile_no || "", // Map mobile_no to cell_number
        status: status,
    };
};
