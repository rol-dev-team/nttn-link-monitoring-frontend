...
export const getTimeoutAlerts = async () => {
  try {
    const response = await axiosInstance.get('/icmp-timeout-alerts');
    return response.data;
  } catch (error) {
    throw error;
  }
...
export const getLatencyAlerts = async () => {
  try {
    const response = await axiosInstance.get('/icmp-latency-alerts');
    return response.data;
  } catch (error) {
    throw error;
  }
