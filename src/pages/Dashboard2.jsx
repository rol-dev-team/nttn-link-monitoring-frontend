    ...
    render: (v) => (
      <span
        className={clsx(
          ...
          v === 'Timeout' ? 'bg-red-100 text-red-900' : 'bg-orange-100 text-orange-900'
        )}
      >
        {safeCell(v)}
      </span>
          ...
          {initialLoading ? (
            ...
            <>
              ...
              <HealthStatCard
                ...
                valueClass={
                  activeCard === 'min_alert' ? 'text-cyan-700 underline' : 'text-cyan-600'
                }
              ...
              <HealthStatCard
                ...
                valueClass={
                  activeCard === 'icmp_alert' ? 'text-orange-700 underline' : 'text-orange-600'
                }
